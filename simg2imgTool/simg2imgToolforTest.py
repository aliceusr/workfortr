...
def unpack_repack_img():
    ...
    os.system('sudo sed -i "s/ro.build.display.id=.*/ro.build.display.id='+PRODUCTNAME+'-'+ appversion+'/g" '+img_dir + '/system/build.prop')
    if CHIP == 'MTK':
        os.system('sudo sed -i "s/ro.itel.version.release=.*/ro.itel.version.release='+PRODUCTNAME+'-'+ appversion+'/g" '+img_dir + '/system/build.prop')
    else:
        os.system('sudo sed -i "s/ro.build.display.spid.customer=.*/ro.build.display.spid.customer='+PRODUCTNAME+'-'+ appversion+'/g" '+img_dir + '/system/build.prop')
